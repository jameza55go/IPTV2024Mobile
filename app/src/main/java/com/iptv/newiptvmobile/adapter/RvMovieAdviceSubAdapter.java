...
public class RvMovieAdviceSubAdapter extends RecyclerView.Adapter<RvMovieAdviceSubAdapter.MyViewHolder> {
    ...
    public RvMovieAdviceSubAdapter(HomeActivity mContext, List<SubData> list, int rvPosition) {
        this.mContext = mContext;
        this.list = list;
        this.rvPosition = rvPosition;
    }

    public RvMovieAdviceSubAdapter(HomeActivity context, List<SubData> list) {
    ...
    @NonNull
    @Override
    public RvMovieAdviceSubAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.item_linear_cover_movie, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RvMovieAdviceSubAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {

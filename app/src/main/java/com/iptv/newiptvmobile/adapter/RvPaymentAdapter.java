...
public class RvPaymentAdapter extends RecyclerView.Adapter<RvPaymentAdapter.MyViewHolder> {

    PaymentActivity activity;
    List<Data> list;


    public RvPaymentAdapter(PaymentActivity activity, List<Data> list) {
    ...
    @NonNull
    @Override
    public RvPaymentAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RvPaymentAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        Data lists = list.get(position);
        holder.setIsRecyclable(false);

        holder.date.setText(lists.getDatetime());
        holder.before_pay.setText(lists.getBefor_vip());
        holder.add_days.setText(lists.getVipday());
        holder.after_pay.setText(lists.getAfter_vip());

...
public class RvGridCategoryAdapter extends RecyclerView.Adapter<RvGridCategoryAdapter.MyViewHolder> {
    ...
    public RvGridCategoryAdapter(Context context, List<Data> list) {
        this.mContext = context;
        this.list = list;
    }

    public RvGridCategoryAdapter(Context context, List<Data> list, String type) {
        this.mContext = context;
        this.list = list;
        this.type = type;
    }
    ...
    @NonNull
    @Override
    public RvGridCategoryAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.item_grid_cover_movie, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RvGridCategoryAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
